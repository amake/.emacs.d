...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (expand-region graphviz-dot-mode neotree groovy-mode counsel web-mode markdown-mode use-package flycheck pcre2el org-plus-contrib magit exec-path-from-shell)))
