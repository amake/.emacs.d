...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (scala-mode counsel-projectile projectile dash-at-point dired-collapse expand-region graphviz-dot-mode groovy-mode counsel web-mode markdown-mode use-package flycheck pcre2el org-plus-contrib magit exec-path-from-shell)))
